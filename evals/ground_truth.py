...
SUBTLE_GROUND_TRUTH: GroundTruth = {
    ...
    ("delete_record", AuditCategory.ERROR_HANDLING): EvalVerdict.FAIL,
...
CHAIN_HONEYPOT_GROUND_TRUTH: GroundTruth = {
    ...
    ("project_manager", AuditCategory.INPUT_VALIDATION): EvalVerdict.PASS,
    ...
    ("user_directory", AuditCategory.INPUT_VALIDATION): EvalVerdict.PASS,
